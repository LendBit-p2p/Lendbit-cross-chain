...
contract Base is Test, IDiamondCut {
    ...
    address AVAX_CONTRACT_ADDRESS = address(2);
    ...
    function deployXDiamonds() public virtual {
        ...
        (
            ABR_USDT_ADDRESS_ON_SPOKE,
            USDT_USD
        ) = deployERC20ContractAndAddPriceFeed("USDT", 6, 1);

        (
            ABR_LINK_ADDRESS_ON_SPOKE,
            LINK_USD
        ) = deployERC20ContractAndAddPriceFeed("LINK", 18, 10);
        ...
        (
            ...
            LINK_USD
        ) = deployERC20ContractAndAddPriceFeed("USDT", 18, 1);
